...
@Component({
selector: "app-user_projects",
templateUrl: "./user_projects.component.html",
styleUrls: ["./user_projects.component.css"]
})
export class user_projectsComponent implements OnInit {
