...
const GET_API = 'https://llalwani.com:8097/api/TaskReportByActivities/Search_Activites_For_Tasks?filter=1&FromDate=2023-02-01&ToDate=2023-03-10';
const GET_DETAILS_API = 'https://llalwani.com:8097/api/TaskReportByActivities/Search_Task_Activity_Wise?filter=2&ActivityId=0';
...
@Component({
selector: "app-activity_wise_task_report",
templateUrl: "./activity_wise_task_report.component.html",
styleUrls: ["./activity_wise_task_report.component.css"]
})
export class activity_wise_task_reportComponent implements OnInit {
