...
const POST_API = 'https://llalwani.com:8097/api/v1.0/Roles';
const GET_API = 'https://llalwani.com:8097/api/v1.0/Roles/GetAll';
const DELETE_API = 'https://llalwani.com:8097/api/v1.0/Roles/';
const UPDATE_API = 'https://llalwani.com:8097/api/v1.0/Roles/';
...
edit(id:any,role_name:any,rowVersion:any)
{
...
const { id,role_name,rowVersion } = this.form;
...
POST_API,
{
    roleDesc:this.sanitize_role_name
} , httpOptions
).subscribe(
(data) => {
