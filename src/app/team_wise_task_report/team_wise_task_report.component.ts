...
const GET_API = 'https://llalwani.com:8097/api/TaskReportByTeams/Search_Teams?filter=2';
const GET_DETAILS_API = 'https://llalwani.com:8097/api/TaskReportByTeams/Search_Team_Wise_Activities?filter=2&TeamId=0&FromDate=2023-02-01&ToDate=2023-03-10';
const GET_DETAILS_API_2 = 'https://llalwani.com:8097/api/MonthlyTaskReport/Search_Activites_By_Tasks?filter=2&EmpId=0&ActivityId=0';
...
@Component({
selector: "app-team_wise_task_report",
templateUrl: "./team_wise_task_report.component.html",
styleUrls: ["./team_wise_task_report.component.css"]
})
export class team_wise_task_reportComponent implements OnInit {
